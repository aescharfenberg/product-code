...
using DWG.ProductCode.TestData.Models;

namespace DWG.ProductCode.TestData
{
    public static class IfspGlobalPriceLookupData
    {
        public static IEnumerator<IfspGlobalPriceLookup> GetEmumerator()
        {
            const string commoditiesCsvResourceName = "DWG.ProductCode.TestData.Resources.Commodities_20170331020353.csv";
